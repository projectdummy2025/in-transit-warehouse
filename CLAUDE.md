...
- **Pure Business Logic**: Logika bisnis (kalkulasi, validasi kompleks, manipulasi data) harus berupa fungsi murni (\_pure functions\_) yang tidak bergantung pada state UI atau database secara langsung. Ini membuatnya mudah di-test dan dibaca.
